...
public class form extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(proses, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        JOptionPane.showMessageDialog(rootPane, "<html><body>UKK KALKULATOR<br>"
                + "Nama&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: MUHAMAD FARHAN SYAH<br>"
                + "NIK&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: 0066650875<br>"
                + "Jurusan&nbsp&nbsp: 12 - REKAYASA PERANGKAT LUNAK<br>"
                + "Blog&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: www.farhansukses.com"
                + "</body></html>");
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int confirm =(JOptionPane.showConfirmDialog(this, "apakah anda ingin keluar dari aplikasi??","keluar",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE));
